		...
		<ul class="am-list">
			<c:forEach items="${dp.list}" var="vo">
				...
				<c:choose>
					...
					<%-- 纯文模式 --%>
					<c:otherwise>
							<li class="am-g am-list-item-dated"><a href="${_acp}/${clickUrl}.shtml?_action_mode=h5&_params=${wcm:urlEncode(param._params)}&_ORD_ID=${vo.ORD_ID}&ordFlag=1" class="am-list-item-hd"><wpf:script
