	...
	<div class="am-list-news-bd">
		<ul class="am-list">
			<c:forEach items="${list}" var="vo">
				<li class="am-g am-list-item-dated"><a href="${_acp}/detail.shtml?id=${vo.ID}&viewKey=${viewKey}&_params=${wcm:urlEncode(param._params)}&_action_mode=h5" class="am-list-item-hd "><c:if
							test="${vo.TOP_FLAG==1}">
